...
describe("Sonzai", () => {
  ...
  it("Idcard", async () => {
    ...
    const addresstocheck="0x1071258E2C706fFc9A32a5369d4094d11D4392Ec"
    const leaf = keccak256(addresstocheck) // address from wallet using walletconnect/metamask
    const proof = tree.getProof(leaf).map(x => buf2hex(x.data))
    await Sonzai.Idcard(proof)
  })
